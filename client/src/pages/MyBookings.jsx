          ...
          >
            ...
            <div className="md:col-span-2">
              <div className="flex items-center gap-2">
                ...
                <p
                  className={`px-3 py-1 text-xs rounded-full capitalize ${booking.status === "confirmed" ? "bg-green-100 text-green-800" : booking.status === "pending" ? "bg-yellow-100 text-yellow-800" : "bg-red-100 text-red-800"}`}
                >
                  {booking.status}
                </p>
              </div>
            ...
            <div className="md:col-span-1 flex flex-col justify-between gap-6">
              <div className="text-sm text-gary0-500 text-right">
                <p>Total Price</p>
