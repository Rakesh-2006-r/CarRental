  ...
  return (
    <div className="px-4 pt-10 md:px-10 w-full">
      <Title
        ...
        subTitle="Track all customer bookings, approve or cancel requests, and manage bookings status."
      />
              ...
              >
                ...
                <td className="p-3">
                  {booking.status === "pending" ? (
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-semibold ${booking.status === "confirmed" ? "bg-green-100 text-green-600" : "bg-red-100 text-red-600"}`}
                    >
                      {booking.status}
                    </span>
                  )}
