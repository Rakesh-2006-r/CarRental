  ...
  return (
    <div className="px-4 pt-10 md:px-10 flex-1">
      <Title
        ...
        subTitle="Monitor overall platform performance including total cars, bookings, revenue and recent bookings."
      />
          ...
          {data.recentBookings.map((booking, index) => (
            <div key={index} className="flex items-center justify-between mt-4">
              ...
              <div className="flex items-center gap-2 font-medium">
                <p className="text-sm text-gray-500">Rs.{booking.totalPrice}</p>
